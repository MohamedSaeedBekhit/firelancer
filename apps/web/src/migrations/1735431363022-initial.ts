...
export class Initial1735431363022 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(
            `CREATE TABLE "balance_entry" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "type" character varying NOT NULL, "description" character varying, "balance" integer, "credit" integer NOT NULL DEFAULT '0', "debit" integer NOT NULL DEFAULT '0', "reviewDays" integer NOT NULL DEFAULT '0', "settledAt" TIMESTAMP, "prevBalance" integer, "prevSettledAt" TIMESTAMP, "metadata" text, "id" SERIAL NOT NULL, "customerId" integer NOT NULL, "parentId" integer, CONSTRAINT "PK_8fb391d29b558b0320c5a0e3036" PRIMARY KEY ("id"))`,
            undefined,
        );
        await queryRunner.query(
