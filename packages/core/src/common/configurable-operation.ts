...
import { LocalizedString } from '@firelancer/common/lib/shared-types';
import { assertNever } from '@firelancer/common/lib/shared-utils';
 ...
 * @example
 * ```ts
 * import { Injector, ShippingCalculator } from '\@firelancer/core';
