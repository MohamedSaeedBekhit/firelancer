import { DEFAULT_AUTH_TOKEN_HEADER_KEY } from '@firelancer/common/lib/shared-constants';
import { AdminUiAppConfig, AdminUiAppDevModeConfig, AdminUiConfig, Type } from '@firelancer/common/lib/shared-types';
import {
    ConfigService,
    createProxyHandler,
    FirelancerPlugin,
